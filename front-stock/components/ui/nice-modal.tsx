...
const getModalId = (modal: string | any): string => {
...
export const NiceModalProvider: React.FC<{
  children: ReactNode;
 ...
 * @returns
 */
export const ModalDef: React.FC<{ id: string; component: React.FC<any> }> = ({
  id,
  component,
}) => {
  useEffect(() => {
 ...
 * @returns
 */
export const ModalHolder: React.FC<{
